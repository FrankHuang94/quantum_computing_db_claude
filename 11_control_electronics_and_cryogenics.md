...
> **Cross-modality closing note.** Whether the bottleneck is a dilution refrigerator's microwatt cooling budget, an ion trap's dozens of stabilized laser beams, a neutral-atom array's optical field of view, or a photonic machine's millions of cryogenic detectors, the pattern is identical: the *classical control and environmental infrastructure* scales worse than the qubits themselves, and only *integration* — moving control onto chips (cryo-CMOS), onto waveguides (integrated photonics), or into foundry processes (silicon photonics) — bends the scaling curve. This is the unifying insight of File 11, and it is why the reader should treat "how will the control and cooling scale?" as a question co-equal with "how good are the qubits?" when assessing any point on the hardware landscape of Files 3–7 and any roadmap of File 19.
